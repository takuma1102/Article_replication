...
mutiple_hetero_dollar_plot <- function(DCDH_list, imputation_list,panel_post,
...
mutiple_hetero_number_plot <- function(DCDH_list, imputation_list,panel_post,
                                       panel_pre, ylim = c(-2, 2)){
...
combined_mutiple_hetero_plot <- function(DCDH_list, imputation_list,panel_post,
                                       panel_pre, ylim = c(-2, 2),
